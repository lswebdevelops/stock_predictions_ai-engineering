...
const predefinedTexts = [
  ...
  `${names[1]}: Faz o L, bem fresco, meio gay. No seu projeto, nunca tem nada o que fazer. Gaúcho. Vive no Rio Grande do Sul debaixo da água, gosta de macho. O cara do hotel que leva cerveja pra ele no quarto de madrugada.`,
